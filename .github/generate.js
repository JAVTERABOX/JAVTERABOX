...
(async () => {
    try {
        ...
        const data = resp.data.reverse(); // ambil terbaru di depan

        // Hapus file lama di posts/
        ...
        data.forEach(post => {
            ...
            if(fixKeys.length === 0) return; // skip jika tidak ada FIX
